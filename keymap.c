...
//╷             ╷             ╷             ╷             ╷             ╷             ╷╷             ╷             ╷             ╷             ╷             ╷             ╷
    ...
    CTL_T(KC_Z) , ALT_T(KC_X) , CMD_T(KC_C) ,     KC_V    ,     KC_B    ,     KC_MUTE  ,   KC_MPLY   ,  KC_N       ,     KC_M    ,     KC_COMM ,     KC_DOT  ,     KC_SLSH ,
                                   ...
                                   _______  ,     KC_LCMD , LT(_NUM,KC_SPC),                LT(_SYM,LSFT(KC_MINS)) ,     KC_RSFT ,     _______
 ),
...
//╷             ╷             ╷             ╷             ╷             ╷             ╷╷             ╷             ╷            ╷             ╷             ╷             ╷
    ...
    LCMD(KC_Z)  ,  LCMD(KC_X) ,  LCMD(KC_C) ,   LCMD(KC_V),   KC_MINS   ,                              KC_LEFT     ,   KC_UP    ,    KC_DOWN  ,    KC_RGHT   ,    KC_COMM  ,

    KC_LCTL     ,  KC_LALT    ,  KC_LCMD    ,   KC_LSFT   ,   KC_PAST   ,  KC_MUTE     ,  KC_MPLY    , KC_P1       ,   KC_P2    ,    KC_P3    ,    KC_P4     ,    KC_5    ,

                                 _______    ,   KC_PSLS   ,   _______   ,                              KC_PERC     ,   KC_EQL   ,    _______      
 ),
...
// └───────────────────────────────────────────────────────────┘
      ...
      if(IS_LAYER_ON(_NUM)){
          if (clockwise) {
            ...
            if (clockwise) {
              tap_code(LCMD(KC_MINS));
          } else {
              tap_code(LCMD(KC_PPLS));
          }
      }
    }
    return true;
