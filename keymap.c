//_____________________________________WHEEL_COME_TRUG88_KEYMAP________________________________________________________________
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
 ...
 /*╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    └───────────────────────────────────────────────────────────┘
                          ...
                          ├─────────┼─────────┼─────────┼─────────┼─────────┤ │╰╯╰╯╰╯╰╯╰╯╰╯╰╯╰╯│ ├─────────┼─────────┼─────────┼─────────┼─────────┤
                          │    A    │    S  {TAB}  D    │    F  {SCL}  G    ├─╯                ╰─┤    H  {SCR}  J  {BSP}  K  {ENT}  L    │    ;    │
                          ├─────────┼─────────┼─────────┼─────────┼─────────┤╭────────╮╭────────╮├─────────┼─────────┼─────────┼─────────┼─────────┤
...
//╷             ╷             ╷             ╷             ╷             ╷             ╷╷             ╷             ╷             ╷             ╷             ╷             ╷
    ...
    CTL_T(KC_Z) , ALT_T(KC_X) , CMD_T(KC_C) ,     KC_V    ,     KC_B    ,     KC_MUTE  ,   KC_MPLY   ,  KC_N       ,     KC_M    ,     KC_COMM ,     KC_DOT  ,     KC_SLSH ,
                                   ...
                                   KC_LCMD  ,    KC_LSFT  , LT(_NUM,KC_SPC),                      LT(_SYM,KC_BSPC) ,  XXXXXXX    ,     XXXXXXX
 ),
...
/*╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    └───────────────────────────────────────────────────────────┘
                           ┌─────────┬─────────┬─────────┬─────────┬─────────┐                    ┌─────────┬─────────┬─────────┬─────────┬─────────┐
                           │  ALLCOPY│   SAVE  │   SCRSF │  SCRS   │    +    │ ╭╮╭╮╭╮╭╮╭╮╭╮╭╮╭╮╭╮ │    1 {VOLU}  2    │    3    │    4    │    5    │
                           ├─────────┼─────────┼─────────┼─────────┼─────────┤ │╰╯╰╯╰╯╰╯╰╯╰╯╰╯╰╯│ ├─────────┼─────────┼─────────┼─────────┼─────────┤
                           │  UNDO   │   CUT   │   COPY  │ PASTE {BRU}  -    ├─╯                ╰─┤    ←  {BRD}  ↑  {BSP}  ↓  {ENT}  →    │    =    │
                           ├─────────┼─────────┼─────────┼─────────┼─────────┤╭────────╮╭────────╮├─────────┼─────────┼─────────┼─────────┼─────────┤
                           │  CTL    │   ALT   │   CMD   │   SFT   │    .    ││  MUTE  ││PLY/PSE ││    6 {VOLD}  7    │    8    │    9    │    0    │
                           └─────────┴─────────┼─────────┼─────────┼─────────┼╰────────╯╰────────╯┼─────────┼─────────┼─────────┼─────────┴─────────┘
                                               │   CAPS  │         │    ▼    │                    │    ▼    │         │    .    │
                                               └─────────┴─────────┴─────────┘                    └───-─────┴─────────┴─────────┘ */
...
//╷             ╷             ╷             ╷             ╷             ╷             ╷╷             ╷             ╷            ╷             ╷             ╷             ╷
    ...
    LCMD(KC_A)  ,  LCMD(KC_S) ,  LSG(KC_3)  ,   LSG(KC_4) ,   KC_PPLS   ,                              KC_P1       ,   KC_P2    ,    KC_P3    ,    KC_P4     ,    KC_5    ,

    LCMD(KC_Z)  ,  LCMD(KC_X) ,  LCMD(KC_C) ,   LCMD(KC_V),   KC_MINS   ,                              KC_RGHT     ,   KC_UP    ,    KC_DOWN  ,    KC_LEFT   ,    KC_EQL  ,

    KC_LCTL     ,  KC_LALT    ,  KC_LCMD    ,   KC_LSFT   ,   KC_COMM   ,  KC_MUTE     ,  KC_MPLY    , KC_P6       ,   KC_P7    ,    KC_P8    ,    KC_P9     ,    KC_P0   ,

                                 KC_CAPS    ,   _______   ,   _______   ,                              _______     ,   _______  ,    KC_COMM
...
/*╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 //╷             ╷             ╷             ╷             ╷             ╷             ╷╷             ╷             ╷             ╷             ╷             ╷             ╷
    KC_F1        ,  KC_F2      ,  KC_F3      ,   KC_F4     ,   KC_LCBR   ,                               KC_RCBR    ,   KC_AT     ,   KC_HASH   ,    KC_DLR   ,  KC_PERC    ,
    ...
    KC_F9        ,  KC_F10     ,  KC_F11     ,   KC_F12    ,   KC_LPRN   ,    KC_MUTE   ,  KC_MPLY    ,  KC_RPRN    , LSFT(KC_GRV),   KC_AMPR   ,LSFT(KC_QUOT), KC_BSLS    ,
                                  ...
                                  QK_BOOT    ,   DEBUG     ,   _______   ,                               _______    , LSFT(KC_MINS),  KC_EXLM
 ),
...
/*  ┌───────────────────────────────────────────────────────────┐
    ...
    const uint16_t PROGMEM bs1_combo[] = {KC_P4, KC_P5, COMBO_END};
    const uint16_t PROGMEM ent1_combo[] = {KC_P5, KC_P6, COMBO_END};
    ...
    //VOLUME_UP_DOWN
    const uint16_t PROGMEM volu_combo[] = {KC_UP, KC_P7, COMBO_END};
    const uint16_t PROGMEM vold_combo[] = {KC_RGHT, KC_P1, COMBO_END};

    //SCREEN_BRIGHTNESS_UP_DOWN
    const uint16_t PROGMEM bru_combo[] = {LCMD(KC_V), KC_MINS, COMBO_END};
    const uint16_t PROGMEM brd_combo[] = {KC_LEFT, KC_P4, COMBO_END};
